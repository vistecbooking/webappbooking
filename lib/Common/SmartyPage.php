...
class SmartyPage extends Smarty
{
    ...
    protected function RegisterFunctions()
    {
        ...
        $this->registerPlugin('function', 'profile_image', array($this, 'GetProfileImage'));
    ...
    public function PrintImage($params, &$smarty)
    {
        ...
        return "<img src=\"$imgPath\" title=\"$alt\" alt=\"$alt\" width=\"$width\" height=\"$height\" $attributes />";
    }
    ...
    public function GetProfileImage($params, &$smarty)
    {
        $imageUrl = Configuration::Instance()->GetKey(ConfigKeys::IMAGE_UPLOAD_URL);
        ...
        {
            return "$imageUrl/profiles/{$params['image']}";
        }
        else
        {
            return "$imageUrl/profiles/noimg.png";
        }
    }
    ...
    public function ResetButton($params, &$smarty)
    {
        ...
        $class = isset($params['class']) ? $params['class'] : '';
        echo '<button type="reset" class="btn btn-secondary ' . $class . '"" ' . $this->GetButtonAttributes($params) . '>' . Resources::GetInstance()->GetString($key) . '</button>';
    }
    ...
    public function SortColumn($params, &$smarty)
    {
        ...
        $indicator = '<i class="fa fa-sort" aria-hidden="true"></i>';
