...
class ManageBlackoutsService implements IManageBlackoutsService
{
	...
	public function Add(DateRange $blackoutDate, $resourceIds, $title, IReservationConflictResolution $reservationConflictResolution, IRepeatOptions $repeatOptions, $announce_id = 0)
	{
		...
		$blackoutSeries->WithAnnounceId($announce_id);
	...
	public function Delete($blackoutId, $updateScope)
	{
		...
		{
			$this->blackoutRepository->DeleteSeriesAnnounce($blackoutId);
		}
		else
		{
