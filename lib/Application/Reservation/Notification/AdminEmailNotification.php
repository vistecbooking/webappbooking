...
abstract class AdminEmailNotification implements IReservationNotification
{
	...
	public function Notify($reservationSeries)
	{
		...
		if($this->SendForAdmin() && $reservationSeries->RequiresApproval())
		{
			$adminUsers = $this->userViewRepo->GetAdmin();
		}
		...
		$admins = array_merge($adminUsers, $resourceAdmins, $applicationAdmins, $groupAdmins);
	 ...
	 * @return bool
	 */
	protected abstract function SendForAdmin();
