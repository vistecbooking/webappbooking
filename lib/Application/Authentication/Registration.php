...
class Registration implements IRegistration
{
							 ...
							 $isAdmin = false)
	{
		...
		$user->ChangeAttributes($attributes->Get(UserAttribute::Phone), $attributes->Get(UserAttribute::Organization), $attributes->Get(UserAttribute::PositionId));
		...
		if ($lineId != null)
		{
			$user->ChangeLineID($lineId);
		}

		if ($advisor != null)
		{
			$user->ChangeAdvisorName($advisor);
		}

		if ($studentId != null)
		{
			$user->ChangeStudentID($studentId);
		}
