...
class FormKeys
{
	...
	const ANNOUNCEMENT_TIME_START = 'announcementTimeStart';
	const ANNOUNCEMENT_START = 'announcementStart';
	const ANNOUNCEMENT_END = 'announcementEnd';
	const ANNOUNCEMENT_TIME_END = 'announcementTimeEnd';
	const ANNOUNCEMENT_PRIORITY = 'announcementPriority';
	const ANNOUNCEMENT_CANCEL_REASON = 'announcementCancelReason';
