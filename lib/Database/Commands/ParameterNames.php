...
class ParameterNames
{
	...
	const ANNOUNCEMENT_TIME_START = '@timeStart';
	const ANNOUNCEMENT_TIME_END = '@timeEnd';
	const ANNOUNCEMENT_CANCEL_REASON = '@cancelReason';
	...
	const ADVISOR_NAME = '@advisorname';
