...
class ColumnNames
{
	...
	const ANNOUNCEMENT_TIME_START = 'start_time';
	const ANNOUNCEMENT_END = 'end_date';
	const ANNOUNCEMENT_TIME_END = 'end_time';
	const ANNOUNCEMENT_TEXT = 'announcement_text';
	const UPDATE_DATE = 'update_date';
	const ANNOUNCEMENT_CANCEL_REASON = 'cancel_reason';
	...
	const BLACKOUT_ANNOUNCE_ID = 'announce_id';
	...
	const POSITION_NAME = 'name';
	const POSITION_NAME_VIEW = 'position_name';
