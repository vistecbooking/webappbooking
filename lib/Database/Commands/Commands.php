...
{
    public function __construct($text, Date $start, $timeStart, Date $end, $timeend, $priority)
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_TIME_START, $timeStart));
        $this->AddParameter(new Parameter(ParameterNames::END_DATE, $end->ToDatabase()));
        $this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_TIME_END, $timeend));
...
{
    public function __construct($userId, $title, $repeatTypeId, $repeatTypeConfiguration, $announce_id)
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_ID, $announce_id));
    }
}
...
{
    public function __construct($groupName, $groupColor)
    {
        parent::__construct(Queries::ADD_GROUP);
        $this->AddParameter(new Parameter(ParameterNames::GROUP_NAME, $groupName));
        $this->AddParameter(new Parameter(ParameterNames::GROUP_COLOR, $groupColor));
    }
}
...
class AddReservationSeriesCommand extends SqlCommand
{
    ...
    )
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::MODE, $mode));
    }
}
...
class AddPositionCommand extends SqlCommand
{
    public function __construct($positionName)
    {
        parent::__construct(Queries::ADD_POSITION);
        $this->AddParameter(new Parameter(ParameterNames::POSITION_NAME, $positionName));
    }
}
...
{
    public function __construct($announcementId,$CancelReason)
    {
        parent::__construct(Queries::DELETE_ANNOUNCEMENT);
        $this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_ID, $announcementId));
        $this->AddParameter(new Parameter(ParameterNames::ANNOUNCEMENT_CANCEL_REASON,$CancelReason));
    }
}
...
class DeleteBlackoutSeriesAndAnnounceCommand extends SqlCommand
{
    public function __construct($instanceId)
    {
        parent::__construct(Queries::DELETE_BLACKOUT_ANNOUNCE_SERIES);
        $this->AddParameter(new Parameter(ParameterNames::BLACKOUT_INSTANCE_ID, $instanceId));
    }
}
...
class DeletePositionCommand extends SqlCommand
{
    public function __construct($positionId)
    {
        parent::__construct(Queries::DELETE_POSITION);
        $this->AddParameter(new Parameter(ParameterNames::POSITION_ID, $positionId));
    }
}
...
class GetAdminCommand extends SqlCommand
{
    public function __construct()
    {
        parent::__construct(Queries::GET_ALL_ADMIN);
...
class GetAllUsersByStatusCommand extends SqlCommand
{
     ...
     */
    public function __construct($userStatusId = AccountStatus::ALL, $groupId = 0)
    {
        if($groupId == 99999)
        {
            parent::__construct(Queries::GET_ALL_USERS_BY_STATUS_AND_NO_GROUP);
        ...
        {
            parent::__construct(Queries::GET_ALL_USERS_BY_STATUS_AND_GROUP);
            $this->AddParameter(new Parameter(ParameterNames::USER_STATUS_ID, $userStatusId));
            $this->AddParameter(new Parameter(ParameterNames::GROUP_ID, $groupId));
        }
    }
...
class GetAllPositionsCommand extends SqlCommand
{
    public function __construct()
    {
        parent::__construct(Queries::GET_ALL_POSITIONS);
    }
}

class GetPositionByIdCommand extends SqlCommand
{
    public function __construct($positionId)
    {
        parent::__construct(Queries::GET_POSITION_BY_ID);
        $this->AddParameter(new Parameter(ParameterNames::POSITION_ID, $positionId));
    }
}
...
class RegisterUserCommand extends SqlCommand
{
                                ...
                                $phone, $organization, $position, $userStatusId, $publicId, $scheduleId)
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::POSITION_ID, $position != 0 ? $position : null));
        $this->AddParameter(new Parameter(ParameterNames::USER_STATUS_ID, $userStatusId));
        $this->AddParameter(new Parameter(ParameterNames::DATE_CREATED, Date::Now()
            ->ToDatabase()));
        $this->AddParameter(new Parameter(ParameterNames::PUBLIC_ID, $publicId));
...
{
    public function __construct($groupId, $groupName, $adminGroupId, $groupColor)
    {
...
class UpdateUserAttributesCommand extends SqlCommand
{
    ...
    )
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::POSITION_ID, $position == 0 ? null : $position));
        $this->AddParameter(new Parameter(ParameterNames::ORGANIZATION, $organization));
    }
}

class UpdateUserPropCommand extends SqlCommand
{
    public function __construct(
        $userId,
        $nickname,
    ...
    {
        parent::__construct(Queries::UPDATE_USER_PROP);
        $this->AddParameter(new Parameter(ParameterNames::USER_ID, $userId));
        $this->AddParameter(new Parameter(ParameterNames::NICKNAME, $nickname));
        $this->AddParameter(new Parameter(ParameterNames::LINE_ID, $lineID));
        $this->AddParameter(new Parameter(ParameterNames::ADVISOR_NAME, $advisorName));
        $this->AddParameter(new Parameter(ParameterNames::STUDENT_ID, $studentID));
        $this->AddParameter(new Parameter(ParameterNames::IS_ADMIN, $isAdmin));
    }
}

class UpdateUserImageCommand extends SqlCommand
{
    public function __construct($userId, $profileImg)
    {
        parent::__construct(Queries::UPDATE_USER_IMAGE);
        $this->AddParameter(new Parameter(ParameterNames::USER_ID, $userId));
        $this->AddParameter(new Parameter(ParameterNames::PROFILE_IMG, $profileImg));
    }
}
...
class UpdateUserFromLdapCommand extends SqlCommand
{
    public function __construct($username, $email, $fname, $lname, $password, $salt, $phone, $organization, $position)
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::PHONE, $phone));
        $this->AddParameter(new Parameter(ParameterNames::ORGANIZATION, $organization));
        $this->AddParameter(new Parameter(ParameterNames::POSITION_ID, $position));
    }
}
...
class UpdatePositionCommand extends SqlCommand
{
    public function __construct($positionId, $positionName)
    {
        parent::__construct(Queries::UPDATE_POSITION);
        $this->AddParameter(new Parameter(ParameterNames::POSITION_ID, $positionId));
        $this->AddParameter(new Parameter(ParameterNames::POSITION_NAME, $positionName));
    }
}
