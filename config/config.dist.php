 ...
 */
$conf['settings']['app.title'] = 'Vistec Booking Manager';			// application title
$conf['settings']['default.timezone'] = 'Asia/Bangkok';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'true';         	// if users can register themselves
$conf['settings']['admin.email'] = 'notice.gotitth@gmail.com';         // email address of admin user
$conf['settings']['admin.email.name'] = 'Vistec Booking Administrator';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'http://booking.gotit.co.th/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'gotit_pom';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'pom123!';
...
$conf['settings']['phpmailer']['smtp.username'] = 'notice.gotitth@gmail.com';
$conf['settings']['phpmailer']['smtp.password'] = 'c@ck1919';
 ...
 * Email
 */
$conf['settings']['email']['default.from.address'] = 'noreply@support.com';
