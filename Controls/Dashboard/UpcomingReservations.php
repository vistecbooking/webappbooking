...
class UpcomingReservations extends DashboardItem implements IUpcomingReservationsControl
{
	...
	{
        $this->Set('DefaultTitle', Resources::GetInstance()->GetString('NoTitleLabelXX'));
        $this->Set('XXXX', Resources::GetInstance()->GetString('NoTitleLabel'));
	...
	public function BindTodayH($Hours)
	{
		$this->Set('TodaysReservationsHours', $Hours);
	}
	...
	public function BindTomorrowH($Hours)
	{
		$this->Set('TomorrowsReservationsHours', $Hours);
	}
	...
	public function BindThisWeekH($Hours)
	{
		$this->Set('ThisWeeksReservationsHours', $Hours);
	}
	...
	public function BindNextWeekH($Hours)
	{
		$this->Set('NextWeeksReservationsHours', $Hours);
	}
...
interface IUpcomingReservationsControl
{
	...
	function BindTodayH($Hours);
	function BindTomorrow($reservations);
	function BindTomorrowH($Hours);
	function BindThisWeek($reservations);
	function BindThisWeekH($Hours);
	function BindNextWeek($reservations);
	function BindNextWeekH($Hours);
}
