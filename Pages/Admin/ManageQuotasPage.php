...
interface IManageQuotasPage extends IActionPage
{
	 ...
	 * @return void
	 */
	public function BindFilterScheduleId($scheduleId);
	 ...
	 * @return void
	 */
	public function SetFilterScheduleId($id);
...
class ManageQuotasPage extends ActionPage implements IManageQuotasPage
{
	...
	public function ProcessPageLoad()
	{
		$s = $_GET["s"];
		if($s){
			$this->SetFilterScheduleId($s);
		}
		else{
			$this->SetFilterScheduleId(null);
		}
	...
	public function BindFilterScheduleId($scheduleId)
	{
		$this->Set('FilterSchedule', $scheduleId);
	}
	...
	public function SetFilterScheduleId($id)
	{
		return $this->filterScheduleId = $id;
	}
