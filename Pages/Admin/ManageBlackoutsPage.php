...
interface IManageBlackoutsPage extends IPageable, IActionPage, IRepeatOptionsComposite
{
	 ...
	 * @return string
	 */
	public function GetAnnounceStartDate();

	/**
	 * @return string
	 */
	public function GetAnnounceStartTime();

	/**
	 * @return string
	 */
	public function GetAnnounceEndDate();

	/**
	 * @return string
	 */
	public function GetAnnounceEndTime();
	...
	public function SetAnnounceStartDate($startDate);

	public function SetAnnounceEndDate($endDate);

	public function SetAnnounceStartTime($startTime);

	public function SetAnnounceEndTime($endTime);
...
class ManageBlackoutsPage extends ActionPage implements IManageBlackoutsPage
{
	...
	public function ProcessPageLoad()
	{
		...
		$this->Set('AddAnnounceStartDate', Date::Now()->ToTimezone($userTimezone));
		$this->Set('AddAnnounceEndDate', Date::Now()->ToTimezone($userTimezone));
								  ...
								  $conflictingBlackouts, $timezone)
	{
		...
		if(!empty($conflictingBlackouts) || count($conflictingBlackouts) > 0){
			$this->Set('FailKey', 'BlackoutNotCreated');
		}
		else{
			$this->Set('FailKey', 'BlackoutWillDeleteReservation');
		}
	...
	public function GetAnnounceId()
	{
		return $this->GetForm(FormKeys::ANNOUNCEMENT_ID);
	}
	...
	public function GetAnnounceStartTime()
	{
		return $this->GetForm(FormKeys::ANNOUNCEMENT_TIME_START);
	}
	...
	public function GetAnnounceEndTime()
	{
		return $this->GetForm(FormKeys::ANNOUNCEMENT_TIME_END);
	}
	...
	public function SetAnnounceId($id)
	{
		$this->Set('AnnounceId', $id);
	}

	public function SetAnnounceStartDate($startDate)
	{
		$this->Set('AnnounceStartDate', $startDate);
	}

	public function SetAnnounceEndDate($endDate)
	{
		$this->Set('AnnounceEndDate', $endDate);
	}

	public function SetAnnounceStartTime($startTime)
	{
		$this->Set('AnnounceStartTime', $startTime);
	}

	public function SetAnnounceEndTime($endTime)
	{
		$this->Set('AnnounceEndTime', $endTime);
	}
