...
interface IReservationPopupPage
{
	...
	/**
	 * @param $SetResourcesGroupName SetResourcesGroupName[]
	 */
	function SetResourcesGroupName($ResourcesGroupName);
	...
	public function SetDuration($duration);
	 ...
	 /**
     * @param floatval $quota_limit
     */
	public function SetQuotaLimit($quota_limit);

	 /**
     * @param floatval $sum_hour
     */
	public function SetSumHour($sum_hour);
...
class ReservationPopupPage extends Page implements IReservationPopupPage
{
	 ...
	 * @return bool
	 */
	function GetShowResourceName()
	{
		return $this->GetQuerystring('isShowResource') == "true" ? true : false;
	}
	...
	function SetResourcesGroupName($ResourcesGroupName)
	{
		$this->Set('resourcesGroupName', $ResourcesGroupName);
	}
	...
	public function SetQuotaLimit($quota_limit)
    {
        $this->Set('quota_limit', $quota_limit);
	}

	public function SetSumHour($sum_hour)
    {
        $this->Set('sum_hour', $sum_hour);
	}
...
class ReservationPopupPresenter
{
	...
	public function PageLoad()
	{
		...
		$this->_page->SetResourcesGroupName($reservation->ResourcesGroupName);
		$this->_page->SetQuotaLimit($reservation->QuotaLimit);
		...
		$this->_page->SetSumHour($reservation->SumHour);
		$this->_page->SetDates($startDate, $endDate);
		$this->_page->SetMode($reservation->Mode);

		if($this->_page->GetShowResourceName())
		{
			$this->_page->SetResourceName($reservation->ResourceName);
		}
