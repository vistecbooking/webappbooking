...
class AutoCompletePage extends SecurePage
{
	...
	public function __construct()
	{
	    ...
	    $this->listMethods[AutoCompleteType::Position] = 'GetPositions';
	}
	...
	private function GetPositions($term)
	{
		$filter = new SqlFilterLike(new SqlFilterColumn(TableNames::POSITIONS,ColumnNames::POSITION_NAME), $term);
		$r = new PositionRepository();
		return $r->GetList(1, PageInfo::All, null, null, $filter)->Results();
	}
