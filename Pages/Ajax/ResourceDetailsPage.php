...
class ResourceDetailsPage extends Page implements IResourceDetailsPage
{
    ...
    public function BindResource(BookableResource $resource, $isFull)
    {
        $this->Set('isFullDetail', $isFull == "true" ? 'full' : 'short');
    ...
    public function GetIsFullDetail()
    {
        return ServiceLocator::GetServer()->GetQuerystring(QueryStringKeys::IS_FULL_DETAIL);
    }
...
class ResourceDetailsPresenter
{
    ...
    public function PageLoad()
    {
        ...
        $isFull = $this->page->GetIsFullDetail();
        $resource = $this->resourceRepository->LoadById($resourceId);
        $this->page->BindResource($resource, $isFull);
