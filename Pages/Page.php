...
abstract class Page implements IPage
{
	...
	protected function __construct($titleKey = '', $pageDepth = 0)
	{
		...
		$this->smarty->assign('CanViewGroupAdmin', $userSession->IsAdmin);
		$this->smarty->assign('CanViewResourceAdmin', $userSession->IsAdmin);
		$this->smarty->assign('CanViewScheduleAdmin', $userSession->IsAdmin);
		// $this->smarty->assign('CanViewResponsibilities',
		// 	$userSession->Username != "admin" && ($userSession->IsGroupAdmin || $userSession->IsResourceAdmin || $userSession->IsScheduleAdmin));
			$this->smarty->assign('CanViewResponsibilities', false);
		...
		$this->smarty->assign('CanViewReports',
				($allowAllUsersToReports || $userSession->IsAdmin));
