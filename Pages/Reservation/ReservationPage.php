...
interface IReservationPage extends IPage, IActionPage
{
	/**
...
abstract class ReservationPage extends ActionPage implements IReservationPage
{
	protected $presenter;
	...
	public function CreateReservationAction()
	{
		$save_page = new ReservationSavePage();
		$save_page->PageLoad();
	}

	public function UpdateReservationAction()
	{
		$update_page = new ReservationUpdatePage();
		$update_page->PageLoad();
	}
}