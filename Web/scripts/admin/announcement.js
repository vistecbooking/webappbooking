function AnnouncementManagement(opts) {
	...
	var elements = {
		...
		editText: $('#editText'),
		editBegin: $('#editBegin'),
		editTimeBeginDate: $('#editTimeBeginDate'),
		editEnd: $('#editEnd'),
		editTimeEndDate: $('#editTimeEndDate'),
	...
	var editAnnouncement = function () {
		...
		elements.editTimeBeginDate.val(announcement.timeStart);
		elements.editEnd.val(announcement.end);
		elements.editEnd.trigger('change');
		elements.editTimeEndDate.val(announcement.timeend);
	...
	AnnouncementManagement.prototype.addAnnouncement = function (id, text, start, end, priority, groupIds, resourceIds, timeStart, timeend) {
		announcements[id] = {id: id, text: text, start: start, end: end, priority: priority, groupIds: groupIds, resourceIds: resourceIds, timeStart:timeStart, timeend:timeend};
	};
}