...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['InsufficientPermissionsError'] = 'You do not have permission to access this equipment ';
		$strings['MissingReservationResourceError'] = 'A equipment was not selected';
		...
		$strings['AllResources'] = 'All Equipment';
		...
		$strings['ResourceCapacity'] = 'This equipment has a capacity of %s people';
		$strings['ResourceCapacityNone'] = 'This equipment has unlimited capacity';
		$strings['AddNewResource'] = 'Add New Equipment';
		$strings['AddNewUser'] = 'Add New User';
		$strings['AddResource'] = 'Add Equipment';
		...
		$strings['ResourcePermissions'] = 'Equipment Permissions';
		...
		$strings['ResourceList'] = 'Equipments to be reserved';
		...
		$strings['Resources'] = 'Equipments';
		$strings['Participants'] = 'Participants';
		$strings['User'] = 'User';
		$strings['Resource'] = 'Equipment';
		$strings['ResourceName'] = 'Equipment Name';
		...
		$strings['ReservationRequiresApproval'] = 'One or more of the equipments reserved require approval before usage.  This reservation will be pending until it is approved.';
		$strings['YourReferenceNumber'] = 'Your reference number is %s';
		$strings['ChangeUser'] = 'Change User';
		$strings['MoreResources'] = 'More Equipments';
		...
		$strings['AddResources'] = 'Add Equipments';
		...
		$strings['AllResourcesOn'] = 'All Equipments On';
		...
		$strings['DeleteGroupWarning'] = 'Deleting this group will remove all associated equipment permissions.  Users in this group may lose access to equipments.';
		...
		$strings['DeleteResourceWarning'] = 'Deleting this equipment will delete all associated data, including';
		...
		$strings['UserPermissionInfo'] = 'Actual access to equipment may be different depending on user role, group permissions, or external permission settings';
		...
		$strings['MoveResourcesAndReservations'] = 'Move equipments and reservations to';
		...
		$strings['NoResourceAdministratorLabel'] = '(No Equipment Administrator)';
		$strings['WhoCanManageThisResource'] = 'Who Can Manage This Equipment?';
		$strings['ResourceAdministrator'] = 'Equipment Administrator';
		...
		$strings['ReservedResources'] = 'Reserved Equipments';
		$strings['ReservedAccessories'] = 'Reserved Accessories';
		$strings['ResourceUsageTimeBooked'] = 'Equipment Usage - Time Booked';
		$strings['ResourceUsageReservationCount'] = 'Equipment Usage - Reservation Count';
		...
		$strings['ResourceFilter'] = 'Equipment Filter';
		$strings['ResourceGroups'] = 'Equipment Groups';
		...
		$strings['ResourceGroupHelp1'] = 'Drag and drop equipment groups to reorganize.';
		$strings['ResourceGroupHelp2'] = 'Right click a equipment group name for additional actions.';
		$strings['ResourceGroupHelp3'] = 'Drag and drop equipments to add them to groups.';
		$strings['ResourceGroupWarning'] = 'If using equipment groups, each equipment must be assigned to at least one group. Unassigned equipments will not be able to be reserved.';
		...
		$strings['ResourceStatus'] = 'Equipment Status';
		$strings['CurrentStatus'] = 'Current Status';
		$strings['AllReservationResources'] = 'All Reservation Equipments';
		$strings['File'] = 'File';
		$strings['BulkResourceUpdate'] = 'Bulk Equipment Update';
		...
		$strings['Dates'] = 'Dates';
		$strings['More'] = 'More';
		$strings['ResourceAvailability'] = 'Equipment Availability';
		...
		$strings['AllResourceStatuses'] = 'All Equipment Statuses';
		...
		$strings['ResourceColor'] = 'Equipment Color';
		...
		$strings['Users'] = 'Users';
		$strings['Guest'] = 'Guest';
		$strings['ResourceDisplayPrompt'] = 'Equipment to Display';
		...
		$strings['UsersWithAccessToResources'] = 'Users With Access To Equipments';
		$strings['ChooseUsersWithAccessToResources'] = 'Choose Users With Access To Equipments';
		...
		$strings['AnyResource'] = 'Any Equipment';
        ...
        $strings['IcsLocationsAsResources'] = 'Locations will be imported as equipments.';
		...
		$strings['ImportResources'] = 'Import Equipments';
		$strings['ExportResources'] = 'Export Equipments';
		$strings['ResourceImportInstructions'] = '<ul><li>File must be in CSV format.</li><li>Name is required field. Leaving other fields blank will set default values.</li><li>Status options are \'Available\', \'Unavailable\' and \'Hidden\'.</li><li>Color should be the hex value. ex) #ffffff.</li><li>Auto assign and approval columns can be true or false.</li><li>Attribute validity will not be enforced.</li><li>Comma separate multiple equipment groups.</li><li>Use the supplied template as an example.</li></ul>';
		$strings['ReservationImportInstructions'] = '<ul><li>File must be in CSV format.</li><li>Email, equipment names, begin, and end are required fields.</li><li>Begin and end require full date time. Recommended format is YYYY-mm-dd HH:mm (2017-12-31 20:30).</li><li>Rules, conflicts, and valid time slots will not be checked.</li><li>Notifications will not be sent.</li><li>Attribute validity will not be enforced.</li><li>Comma separate multiple equipment names.</li><li>Use the supplied template as an example.</li></ul>';
		...
		$strings['NoResourcePermission'] = 'You do not have permission to access one or more of the requested equipments.';
		...
		$strings['AccessoryResourceRequiredErrorMessage'] = 'Accessory %s can only be booked with equipments %s';
		...
		$strings['AccessoryResourceAssociationErrorMessage'] = 'Accessory \'%s\' cannot be booked with the requested equipments';
		$strings['NoResources'] = 'You have not added any equipments.';
		...
		$strings['ManageResources'] = 'Equipment';
		...
		$strings['ResourceCalendar'] = 'Equipment Calendar';
		...
		$strings['ResourceReservations'] = 'Equipment Reservations';
		...
		$strings['ManageResourceGroups'] = 'Equipment Groups';
		$strings['ManageResourceTypes'] = 'Categories';
		$strings['ManageResourceStatus'] = 'Equipment Statuses';
