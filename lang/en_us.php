...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['Yes'] = 'Yes';
		$strings['No'] = 'No';
		$strings['SelectItem'] = 'Select Item';
		$strings['SelectRequired'] = 'Please select a value';
		...
		$strings['ReservationTitleRequired'] = 'Sample description is required.';
		$strings['Today'] = 'Today';
		$strings['Week'] = 'Week';
		$strings['Month'] = 'Month';
		$strings['BackToCalendar'] = 'Back to calendar';
		$strings['BeginDate'] = 'Begin';
		$strings['BeginBlackout'] = 'Begin Blackout';
		$strings['BeginAnnouncement'] = 'Begin Announcement';
		$strings['TimeBeginDate'] = 'Begin Time';
		$strings['EndDate'] = 'End';
		$strings['EndBlackout'] = 'End Blackout';
		$strings['EndAnnouncement'] = 'End Announcement';
		$strings['TimeEndDate'] = 'End Time';
		...
		$strings['InsufficientPermissionsError'] = 'You do not have permission to access this instrument ';
		$strings['MissingReservationResourceError'] = 'A instrument was not selected';
		...
		$strings['EditReservationHeading'] = 'Editing a Reservation %s';
		$strings['ViewReservationHeading'] = 'Viewing Reservation %s';
		$strings['ReservationErrors'] = 'Change Reservation';
		$strings['ReservationCancel'] = 'Cancel Reservation';
		...
		$strings['AllResources'] = 'All Instrument';
		...
		$strings['Location'] = 'Building';
		$strings['NoLocationLabel'] = '(no location set)';
		$strings['Contact'] = 'Personal in charge';
		$strings['NoContactLabel'] = '(no personal in charge information)';
		$strings['Description'] = 'Description';
		$strings['NoDescriptionLabel'] = '(no description)';
		$strings['Notes'] = 'Notes';
		$strings['NoNotesLabel'] = '(no notes)';
		$strings['Room'] = 'Room';
		$strings['NoRoomLabel'] = '(no room set)';
		...
		$strings['ResourceCapacity'] = 'This instrument has a capacity of %s people';
		$strings['ResourceCapacityNone'] = 'This instrument has unlimited capacity';
		$strings['AddNewResource'] = 'Add New Instrument';
		$strings['AddNewUser'] = 'Add New User';
		$strings['AddResource'] = 'Add Instrument';
		...
		$strings['ResourcePermissions'] = 'Instrument Permissions';
		...
		$strings['ResourceList'] = 'Instruments to be reserved';
		...
		$strings['Resources'] = 'Instruments';
		$strings['Participants'] = 'Participants';
		$strings['User'] = 'User';
		$strings['Resource'] = 'Instrument';
		$strings['ResourceName'] = 'Instrument Name';
		...
		$strings['RegisteredEmailAddress'] = 'Registered Email Address';
		$strings['Phone'] = 'Phone No.';
		$strings['Organization'] = 'Academic school';
		$strings['Position'] = 'Position';
		$strings['Language'] = 'Language';
		$strings['Permissions'] = 'Permissions';
		$strings['ProfileImg'] = 'Profile image';
		$strings['Reset'] = 'Reset';
		$strings['FindGroup'] = 'Find Group';
		$strings['Manage'] = 'Manage';
		$strings['None'] = 'None';
		$strings['AddToOutlook'] = 'Add to email calendar';
		$strings['Done'] = 'Done';
		...
		$strings['ReservationRequiresApproval'] = 'One or more of the instruments reserved require approval before usage.  This reservation will be pending until it is approved.';
		$strings['YourReferenceNumber'] = 'Your reference number is %s';
		$strings['ChangeUser'] = 'Change User';
		$strings['MoreResources'] = 'More Instruments';
		...
		$strings['AddResources'] = 'Add Instruments';
		...
		$strings['AnnouncementCancelReason'] = 'Input reason to deleted:';
		...
		$strings['AllResourcesOn'] = 'All Instruments On';
		$strings['Reason'] = 'Reason';
		$strings['BlackoutShowMe'] = 'Show delete conflicting reservations';
		...
		$strings['BlackoutWillDeleteReservation'] = 'Blackout will delete or change conflicting reservations';
		...
		$strings['DeleteGroupWarning'] = 'Deleting this group will remove all associated instrument permissions.  Users in this group may lose access to instruments.';
		...
		$strings['DeleteResourceWarning'] = 'Deleting this instrument will delete all associated data, including';
		...
		$strings['LayoutInstructions'] = 'Enter one time slot per line.  Time slots must be provided for all 24 hours of the day.';
		$strings['AddUser'] = 'Add User';
		$strings['UserPermissionInfo'] = 'Actual access to instrument may be different depending on user role, group permissions, or external permission settings';
		...
		$strings['MoveResourcesAndReservations'] = 'Move instruments and reservations to';
		...
		$strings['NoResourceAdministratorLabel'] = '(No Instrument Administrator)';
		$strings['WhoCanManageThisResource'] = 'Who Can Manage This Instrument?';
		$strings['ResourceAdministrator'] = 'Instrument Administrator';
		...
		$strings['ReservedResources'] = 'Reserved Instruments';
		$strings['ReservedAccessories'] = 'Reserved Accessories';
		$strings['ResourceUsageTimeBooked'] = 'Instrument Usage - Time Booked';
		$strings['ResourceUsageReservationCount'] = 'Instrument Usage - Reservation Count';
        ...
        $strings['DeleteReminderWarning'] = 'Do you want to delete your reservation?';
		...
		$strings['ResourceFilter'] = 'Instrument Filter';
		$strings['ResourceGroups'] = 'Instrument Groups';
		...
		$strings['ResourceGroupHelp1'] = 'Drag and drop instrument groups to reorganize.';
		$strings['ResourceGroupHelp2'] = 'Right click a instrument group name for additional actions.';
		$strings['ResourceGroupHelp3'] = 'Drag and drop instruments to add them to groups.';
		$strings['ResourceGroupWarning'] = 'If using instrument groups, each instrument must be assigned to at least one group. Unassigned instruments will not be able to be reserved.';
		$strings['ResourceType'] = 'Category';
		$strings['AppliesTo'] = 'Applies To';
		$strings['UniquePerInstance'] = 'Unique Per Instance';
		$strings['AddResourceType'] = 'Add Category';
		$strings['NoResourceTypeLabel'] = '(no category set)';
		...
		$strings['ResourceStatus'] = 'Instrument Status';
		$strings['CurrentStatus'] = 'Current Status';
		$strings['AllReservationResources'] = 'All Reservation Instruments';
		$strings['File'] = 'File';
		$strings['BulkResourceUpdate'] = 'Bulk Instrument Update';
		$strings['Unchanged'] = 'Unchanged';
		$strings['Common'] = 'Common';
		$strings['AdminOnly'] = 'Is Admin Only';
		$strings['IsAdmin'] = 'Is Admin';
		...
		$strings['Dates'] = 'Dates';
		$strings['More'] = 'More';
		$strings['ResourceAvailability'] = 'Instrument Availability';
		...
		$strings['AllResourceTypes'] = 'All Categories';
		$strings['AllResourceStatuses'] = 'All Instrument Statuses';
		...
		$strings['ResourceColor'] = 'Instrument Color';
		...
		$strings['Users'] = 'Users';
		$strings['Guest'] = 'Guest';
		$strings['ResourceDisplayPrompt'] = 'Instrument to Display';
		...
		$strings['ChooseSendAsEmail'] = 'Click for Notification by Email';
		$strings['UsersInGroups'] = 'Users In Groups';
		$strings['ChooseUsersInGroups'] = 'Choose Groups for Notification ';
		$strings['UsersWithAccessToResources'] = 'Users With Access To Instruments';
		$strings['ChooseUsersWithAccessToResources'] = 'Choose Users With Access To Instruments';
		...
		$strings['AnyResource'] = 'Any Instrument';
        ...
        $strings['IcsLocationsAsResources'] = 'Locations will be imported as instruments.';
		...
		$strings['ImportResources'] = 'Import Instruments';
		$strings['ExportResources'] = 'Export Instruments';
		$strings['ResourceImportInstructions'] = '<ul><li>File must be in CSV format.</li><li>Name is required field. Leaving other fields blank will set default values.</li><li>Status options are \'Available\', \'Unavailable\' and \'Hidden\'.</li><li>Color should be the hex value. ex) #ffffff.</li><li>Auto assign and approval columns can be true or false.</li><li>Attribute validity will not be enforced.</li><li>Comma separate multiple instrument groups.</li><li>Use the supplied template as an example.</li></ul>';
		$strings['ReservationImportInstructions'] = '<ul><li>File must be in CSV format.</li><li>Email, instrument names, begin, and end are required fields.</li><li>Begin and end require full date time. Recommended format is YYYY-mm-dd HH:mm (2017-12-31 20:30).</li><li>Rules, conflicts, and valid time slots will not be checked.</li><li>Notifications will not be sent.</li><li>Attribute validity will not be enforced.</li><li>Comma separate multiple instrument names.</li><li>Use the supplied template as an example.</li></ul>';
		...
		$strings['Positions'] = 'Positions';
		$strings['AllPositions'] = 'All Positions';
		$strings['PositionName'] = 'Position Name';
		$strings['FindPosition'] = 'Find Position';
		$strings['DeletePositionWarning'] = 'Deleting this position will clear position value of users.  Users in this position may defind position value again.';
		$strings['AddNewPosition'] = 'Add a new position';
		$strings['AddPosition'] = 'Add Position';
		$strings['NickName'] = 'Nickname';
		$strings['AdvisorName'] = 'Advisor Name';
		$strings['LineID'] = 'Line ID';
		...
		$strings['NoResourcePermission'] = 'You do not have permission to access one or more of the requested instruments.';
		...
		$strings['AccessoryResourceRequiredErrorMessage'] = 'Accessory %s can only be booked with instruments %s';
		...
		$strings['AccessoryResourceAssociationErrorMessage'] = 'Accessory \'%s\' cannot be booked with the requested instruments';
		$strings['NoResources'] = 'You have not added any instruments.';
		...
		$strings['ManageResources'] = 'Instrument';
		...
		$strings['ResourceCalendar'] = 'Instrument Calendar';
		...
		$strings['ResourceReservations'] = 'Instrument Reservations';
		...
		$strings['ManageResourceGroups'] = 'Instrument Groups';
		$strings['ManageResourceTypes'] = 'Categories';
		$strings['ManageResourceStatus'] = 'Instrument Statuses';
		$strings['ReservationColors'] = 'Reservation Colors';
		$strings['SearchReservations'] = 'Search Reservations';
		$strings['ManagePositions'] = 'Positions';
		// End Page Titles
