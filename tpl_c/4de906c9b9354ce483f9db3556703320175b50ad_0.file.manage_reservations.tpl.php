<?php
/* Smarty version 3.1.30, created on 2020-11-14 16:48:58
  from "/var/www/html/booking/tpl/Admin/Reservations/manage_reservations.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5fafa80a1354e0_79946123',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4de906c9b9354ce483f9db3556703320175b50ad' => 
    array (
      0 => '/var/www/html/booking/tpl/Admin/Reservations/manage_reservations.tpl',
      1 => 1604760004,
      2 => 'file',
    ),
  ),
...
function content_5fafa80a1354e0_79946123 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<div class="row">
			...
			<div class="col-auto mb-3">
				<?php if ($_smarty_tpl->tpl_vars['CanViewAdmin']->value) {?>
					<a role="menuitem" href="#" id="import-reservations" class="add-link link-primary"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Import'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>"file-import.svg",'style'=>"height:1rem"),$_smarty_tpl);?>
</a>
...
" class="add-link link-primary" target="_blank"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Export'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>"file-export.svg",'style'=>"height:1rem"),$_smarty_tpl);?>
</a>
			</div>
		</div>
		<div class="box box-bordered">
			<h2><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>"Filter"),$_smarty_tpl);?>
</h2>
			<form id="filterForm" role="form">
				<div class="form-row">
					<div class="col-12 col-md-6 col-lg filter-status <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
"">
...
"
					...
					<div class="col-12 col-md-6 col-lg form-group filter-user <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
">
...
"/>
					...
					<div class="col-12 col-md-6 col-lg filter-schedule <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
">
					...
					<div class="col-12 col-md-6 col-lg filter-resource <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
"">
				...
				<div class="form-row">
					<div class="col-12 col-md-6 col-lg">
						<div class="row no-gutters">
							<div class="col form-group mb-3 filter-dates <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
">
...
"/>
					...
					<div class="col-12 col-md-6 col-lg form-group mb-3 filter-referenceNumber <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
"">
...
"/>
					...
					<div class="col-12 col-md-6 col-lg filter-resourceStatus <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
">
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Hidden'),$_smarty_tpl);?>
					...
					<div class="col-12 col-md-6 col-lg filter-resourceStatusReason <?php echo $_smarty_tpl->tpl_vars['groupClass']->value;?>
">
						<select id="resourceReasonIdFilter" class="form-control"></select>
					</div>
				</div>
				<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['filter_button'][0][0]->FilterButton(array('id'=>"filter"),$_smarty_tpl);?>

				<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['reset_button'][0][0]->ResetButton(array('id'=>"clearFilter"),$_smarty_tpl);?>
...
?>
		...
		<tr>
			...
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['sort_column'][0][0]->SortColumn(array('key'=>'User','field'=>ColumnNames::OWNER_LAST_NAME),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['sort_column'][0][0]->SortColumn(array('key'=>'Resource','field'=>ColumnNames::RESOURCE_NAME),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['sort_column'][0][0]->SortColumn(array('key'=>'Title','field'=>ColumnNames::RESERVATION_TITLE),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['sort_column'][0][0]->SortColumn(array('key'=>'Description','field'=>ColumnNames::RESERVATION_DESCRIPTION),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['sort_column'][0][0]->SortColumn(array('key'=>'BeginDate','field'=>ColumnNames::RESERVATION_START),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['sort_column'][0][0]->SortColumn(array('key'=>'EndDate','field'=>ColumnNames::RESERVATION_END),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Duration'),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'ReferenceNumber'),$_smarty_tpl);?>
</th>
			<?php if ($_smarty_tpl->tpl_vars['CreditsEnabled']->value) {?>
				<th style="border: 1px solid #a09e9e;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Credits'),$_smarty_tpl);?>
</th>
				<?php $_smarty_tpl->_assignInScope('colCount', $_smarty_tpl->tpl_vars['colCount']->value+1);
?>
			<?php }?>
			<?php if (!$_smarty_tpl->tpl_vars['IsDesktop']->value) {?>
				<th style="border: 1px solid #a09e9e;" class="action"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Edit'),$_smarty_tpl);?>
</th>
				<?php $_smarty_tpl->_assignInScope('colCount', $_smarty_tpl->tpl_vars['colCount']->value+1);
?>
			<?php }?>
			<th style="border: 1px solid #a09e9e;" class="action"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Approve'),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;" class="action"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Delete'),$_smarty_tpl);?>
</th>
			<th style="border: 1px solid #a09e9e;" class="action-delete">
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fullname'][0][0]->DisplayFullName(array('first'=>$_smarty_tpl->tpl_vars['reservation']->value->FirstName,'last'=>$_smarty_tpl->tpl_vars['reservation']->value->LastName,'ignorePrivacy'=>true),$_smarty_tpl);?>
</td>
				...
				<td class="action-delete no-edit"  style="
...
"/>
						<label for="delete<?php echo $_smarty_tpl->tpl_vars['reservationId']->value;?>
"></label>
					</div>
				</td>
			</tr>
