<?php
/* Smarty version 3.1.30, created on 2020-11-08 21:40:28
  from "/var/www/html/booking/tpl/Admin/manage_quotas.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5fa8035c974284_17523792',
...
function content_5fa8035c974284_17523792 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
							<?php if ($_smarty_tpl->tpl_vars['schedule']->value->GetId() == $_smarty_tpl->tpl_vars['FilterSchedule']->value) {?>
								<option value='<?php echo $_smarty_tpl->tpl_vars['schedule']->value->GetId();?>
' selected><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['schedule']->value->GetName(),',',' ');?>
</option>
							<?php } else { ?>
								<option value='<?php echo $_smarty_tpl->tpl_vars['schedule']->value->GetId();?>
...
?>
					...
					<select style='display:none;' class='form-control' <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'UNIT'),$_smarty_tpl);?>
 title='Quota unit' >
...
?>
 ...
 title='Quota frequency' style='display:none;' >
...
?>
					...
					<div class='form-group'>
						<select  style='display:none;' class='form-control' <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'QUOTA_SCOPE'),$_smarty_tpl);?>
>
							<option value='<?php echo QuotaScope::IncludeCompleted;?>
'><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'IncludingCompletedReservations'),$_smarty_tpl);?>
</option>
							<option value='<?php echo QuotaScope::ExcludeCompleted;?>
' selected><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'NotCountingCompletedReservations'),$_smarty_tpl);?>
</option>
						</select>
					</div>
				<?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
