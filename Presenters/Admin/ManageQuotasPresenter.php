...
class ManageQuotasPresenter extends ActionPresenter
{
	...
	{
		$filterScheduleId = $this->page->GetFilterScheduleId();

		$groups = $this->groupRepository->GetList()->Results();
		$schedules = $this->scheduleRepository->GetAll();

		if($filterScheduleId != null){
			$resources =$this->resourceRepository->GetScheduleResources($filterScheduleId);
		}
		else{
		...
		$this->page->BindFilterScheduleId($filterScheduleId);
