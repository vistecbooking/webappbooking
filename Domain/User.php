...
class User
{
	...
	public static function FromRow($row)
	{
		...
		$user->advisorName = $row[ColumnNames::ADVISOR_NAME];
		...
		$user->attributes[UserAttribute::PositionId] = $row[ColumnNames::POSITION_ID];
		$user->attributes[UserAttribute::PositionName] = $row[ColumnNames::POSITION_NAME_VIEW];
	...
	public function ChangeAdvisorName($advisorName)
	{
		$this->userPropChanged = true;
	...
	public function ChangeLineID($lineID)
	{
		$this->userPropChanged = true;
		$this->lineID = $lineID;
	}
	...
	public function ChangeProfileImg($profileImg)
	{
		$this->profileImg = $profileImg;
	}

	public function ChangeIsAdmin($isAdmin)
	{
		$this->userPropChanged = true;
		$this->isAdmin = $isAdmin;
	}

	public function HaveUserPropChanged()
	{
		return $this->userPropChanged;
	}

	public function ChangeAttributes($phone, $organization, $positionId)
	{
		$this->attributesChanged = true;

		$this->attributes[UserAttribute::Phone] = $phone;
		$this->attributes[UserAttribute::Organization] = $organization;
		$this->attributes[UserAttribute::PositionId] = $positionId;
	}
