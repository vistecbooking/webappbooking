...
<div id="resourceDetailsPopup">
    ...
    {if $isFullDetail == 'full'}
        ...
        <div class="description">
            ...
            {if $contactInformation neq ''}
                <div style="white-space: pre-wrap">{$contactInformation}</div>
            {else}
            ...
            {/if}
            <br/>
            <span class="bold">{translate key=Room}</span>
            {if $notes neq ''}
                {$notes}
            {else}
    ...
    {else}
        <div class="description">
            ...
            {if $locationInformation neq ''}
                {$locationInformation} building {if $notes neq ''} ({$notes}) {/if}
            {else}
                {translate key=NoLocationLabel}
            {/if}
            <br/>
