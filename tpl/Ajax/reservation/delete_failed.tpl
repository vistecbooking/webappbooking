...
<div>
	...
	<div class="error">
		...
		{assign var=ww value=$each}
			<div>{$each|nl2br}</div>
		{/foreach} 
	</div>

	<div style="margin-top:15px;">
	 {if $ww == "Cancellation of reservation must be made at least 24 hours in advance." }
							<button id="btnSaveFailed" class="btn btn-warning"><span class="fa fa-arrow-circle-left"></span> Back</button>
								{else}
