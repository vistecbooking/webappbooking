    ...
    <nav class="navbar navbar-default {if $IsDesktop}navbar-fixed-top{else}navbar-static-top adjust-nav-bar-static{/if}"
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{$HomeUrl}">{html_image src="$LogoUrl?2.6" alt="$Title" style="height: 50px"}</a>
            </div>
                            ...
                            <li class="dropdown" id="navApplicationManagementDropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li id="navManagePositions"><a
                                                href="{$Path}admin/manage_positions.php">{translate key="ManagePositions"}</a>
                                    </li>
