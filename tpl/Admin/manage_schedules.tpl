            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="addSameLayoutAs"  title="text">{translate key=UseSameLayoutAs}</label> <i class="fa fa-question-circle tooltipd"><span class="tooltiptext">Use format schedule form that you have it before.</span></i>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="slotWizard col-xs-12">
                            <h5>
                                ...
                                <a class="btn btn-info" style="color: #ffffff;" href="#" id="createQuickLayout">{translate key=Create}</a>
                            </h5>
                        </div>
                         </div>
                        <div class="row" style="margin-top: 15px;" >
                        <div class="slotHelpText col-xs-12">
                            ...
                            <p>1.{translate key=Format}: <span>HH:MM - HH:MM {translate key=OptionalLabel}</span></p>

                            <p>2.{translate key=LayoutInstructions}</p>
                        </div>
                        </div>
