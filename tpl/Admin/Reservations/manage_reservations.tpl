...
<div id="page-manage-reservations" class="admin-page">
	...
	<table class="table admin-panel" id="reservationTable">
		...
		<tr>
			...
			<th style="border: 1px solid #a09e9e;">{sort_column key=User field=ColumnNames::OWNER_LAST_NAME}</th>
			<th style="border: 1px solid #a09e9e;">{sort_column key=Resource field=ColumnNames::RESOURCE_NAME}</th>
			<th style="border: 1px solid #a09e9e;">{sort_column key=Title field=ColumnNames::RESERVATION_TITLE}</th>
			<th style="border: 1px solid #a09e9e;">{sort_column key=Description field=ColumnNames::RESERVATION_DESCRIPTION}</th>
			<th style="border: 1px solid #a09e9e;">{sort_column key=BeginDate field=ColumnNames::RESERVATION_START}</th>
			<th style="border: 1px solid #a09e9e;">{sort_column key=EndDate field=ColumnNames::RESERVATION_END}</th>
			<th style="border: 1px solid #a09e9e;">{translate key='Duration'}</th>
			<th style="border: 1px solid #a09e9e;">{translate key='ReferenceNumber'}</th>
			{if $CreditsEnabled}
				<th style="border: 1px solid #a09e9e;">{translate key='Credits'}</th>
				{assign var=colCount value=$colCount+1}
			{/if}
			{if !$IsDesktop}
				<th style="border: 1px solid #a09e9e;" class="action">{translate key='Edit'}</th>
				{assign var=colCount value=$colCount+1}
			{/if}
			<th style="border: 1px solid #a09e9e;" class="action">{translate key='Approve'}</th>
			<th style="border: 1px solid #a09e9e;" class="action">{translate key='Delete'}</th>
...
">{fullname first=$reservation->FirstName last=$reservation->LastName ignorePrivacy=true}</td>
